...
const techStack = [
  { src: 'homePage/javascript.svg', alt: 'Javascript' },
  { src: 'homePage/nodejs.svg', alt: 'Nodejs' },
  { src: 'chatApp/express.svg', alt: 'Express.js' },
  { src: 'chatApp/socket.svg', alt: 'Socket.io' },
...
export default function AboutFileShare() {
  return (
    <section className='relative min-h-screen flex flex-col items-center justify-center overflow-hidden px-6'>
      ...
      >
        <h1 className='text-5xl md:text-7xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 !leading-[1.3]'>
          Chat App
        </h1>
        <p className='text-xl md:text-2xl text-gray-300 mb-8'>
          Easy and user friendly chat app
        </p>
        <div className='flex justify-center gap-4'>
          <MotionLink href='https://chat-app-latest-6aeg.onrender.com'>
            Visit Website
          </MotionLink>
          <MotionLink href='https://github.com/shreyas-3456/chat-app'>
            View Repo
          </MotionLink>
        </div>
      </motion.div>
