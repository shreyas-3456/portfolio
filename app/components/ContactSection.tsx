        ...
        >
          ...
          <div className='relative z-10'>
            ...
            <div className='flex flex-col items-center gap-6 mb-8'>
              <motion.a
                href='mailto:shreyas.nigam25@gmail.com'
              ...
              >
                ...
                <span className='font-medium text-gray-400 pointer-events-none'>
                  View Resume
                </span>
              </motion.a>
            </div>
            <div className='flex flex-wrap justify-center gap-6'>
              <motion.a
                href='https://github.com/shreyas-3456/'
                whileHover={{ scale: 1.05 }}
                target='_blank'
                whileTap={{ scale: 0.95 }}
              ...
              <motion.a
                href='https://www.linkedin.com/in/shreyas-nigam-7aa1ab150/'
                whileHover={{ scale: 1.05 }}
                target='_blank'
                whileTap={{ scale: 0.95 }}
